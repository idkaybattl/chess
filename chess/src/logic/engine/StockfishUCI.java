...
public class StockfishUCI implements EngineOpponent {
    ...
    public StockfishUCI(String stockfishPath, int waitTime, int elo) {
        this.path = stockfishPath;
    ...
    public MoveChoice requestMove(ChessGame logic) {
        var moveUCI = getBestMove(logic.getUCIMoves(), waitTime);
        return new MoveChoice(moveUCI);
    }
     ...
     */
    public String getBestMove(String moves, int waitTime) {
        sendCommand("position startpos moves " + moves.trim());
        ...
        try {
            ...
            throw new IllegalStateException("Could not read Stockfish bestmove", e);
        }

        throw new IllegalStateException("Stockfish stopped before returning bestmove");
    }
